...
if ($('#pageWrapper').hasClass('horizontal-wrapper enterprice-type')) {
...
// page active
if ($('#pageWrapper').hasClass('compact-horizontal-wrapper enterprice-type')) {
...
function togglePinnedName() {
    if (!pinTitle) return; // Sortir si pinTitle est null
