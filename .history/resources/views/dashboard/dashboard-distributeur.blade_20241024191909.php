...
@endsection
    ...
    <div class="col-md-4"> <!-- Taille de la carte principale conservée -->
        <div class="card p-3 shadow-sm rounded-lg mb-3 bg-dark text-white"> <!-- Changement de couleur de fond -->
            <div class="d-flex justify-content-between align-items-center text-center"> <!-- Contenu centré -->
                ...
                <div class="d-flex flex-column align-items-center">
                    <div class="mb-2">
                        <div class="icon-circle bg-primary text-white d-flex justify-content-center align-items-center" style="width: 40px; height: 40px; border-radius: 50%;"> <!-- Taille réduite -->
...
<div class="row justify-content-center mt-3"> <!-- Ajout de mt-3 -->
    <div class="col-md-3 mb-3">
        <div class="card p-2 shadow-sm card-hover bg-secondary text-white"> <!-- Background sombre et hover -->
