                    ...
                    <div class="card-header pb-0 card-no-border">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-4"> <!-- Taille de la carte principale conservée -->
                                <div class="card p-3 shadow-sm rounded-lg mb-3 bg-light text-white"> <!-- Changement de couleur de fond -->
                        ...
                        <div class="row justify-content-center mt-3"> <!-- Ajout de mt-3 -->
                            <div class="col-md-3 mb-3">
                                <div class="card p-2 shadow-sm card-hover bg-light text-white"> <!-- Background sombre et hover -->
