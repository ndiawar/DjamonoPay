                ...
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-4"> <!-- Smaller width -->
                                <div class="card p-3 shadow-sm rounded-lg mb-3"> <!-- Added margin bottom -->
                                    <div class="d-flex justify-content-between align-items-center text-center"> <!-- Centered content -->
                                        <div>
                                        ...
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="mb-2">
                                                <div class="icon-circle bg-primary text-white d-flex justify-content-center align-items-center" style="width: 40px; height: 40px; border-radius: 50%;"> <!-- Reduced size -->
                                                    <i class="fs-5 bi bi-send-fill"></i> <!-- Smaller icon -->
                                                </div>
                                                <span class="d-block mt-1 text-center">Envoyer</span>
                                            </div>
                                            <div>
                                                <div class="icon-circle bg-primary text-white d-flex justify-content-center align-items-center" style="width: 40px; height: 40px; border-radius: 50%;"> <!-- Reduced size -->
                                                    <i class="fs-5 bi bi-arrow-down-circle-fill"></i> <!-- Smaller icon -->
                                                </div>
                            ...
                            <div class="rowjustify-content-center mt-3"> <!-- Added margin-top -->
                            <div class="w-75 col-md-4 mb-3"> <!-- Smaller card size and margin bottom -->
                            ...
                            <div class="w-75 col-md-4 mb-3"> <!-- Same as above -->
                                <div class="card p-2 shadow-sm">
