    ...
    <div class="row">
        <div class="col-md-6">
            <div class="credit-card">
                <i class="bi bi-credit-card-front"></i>
                <div class="card-number">44 5858 6585 5558 3333 8564 2485</div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="credit-card">
                <i class="bi bi-credit-card-back"></i>
                <div class="card-number">12/25</div>
            </div>
        </div>
    </div>
    </div>
