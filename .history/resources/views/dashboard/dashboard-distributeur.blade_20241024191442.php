                ...
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="row w-75 justify-content-center mt-3"> <!-- Added margin-top -->
                            <div class="col-md-4 mb-3"> <!-- Smaller card size and margin bottom -->
                            ...
                            <div class="col-md-4 mb-3"> <!-- Same as above -->
                                <div class="card p-2 shadow-sm">
