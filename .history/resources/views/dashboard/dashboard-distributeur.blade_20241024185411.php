                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 offset-md-3">
                                <div class="card-solde">
                                    <div class="d-flex bg-white justify-content-between"> <!-- Ajout de justify-content-between -->
                                        <div class="flex-grow-1">
                                            <h6 class="text-muted">Solde</h6>
                                            <h2>$128,320</h2>
                                        </div>
                                        <div class="solde-actions d-block flex-column align-items-end"> <!-- Changement en flex-column -->
                                            <div class="text-center mb-1"> <!-- Espacement entre les icônes -->
                                            ...
                                            <div class="text-center">
                                                <div class="icon-circle">
                                                    <i class="fs-6 bi bi-arrow-down-circle-fill"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
